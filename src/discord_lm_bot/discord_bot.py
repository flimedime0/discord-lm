...
@tree.command(name="chat", description="Send a prompt to the AI")
@app_commands.describe(
    prompt="Your question or request",
    model="Optionally switch and save your model",
)
...
async def slash_chat(
    ...
    try:
        ...
        chunks = split_message(final_reply + suffix, suffix_len=len(suffix))
        for chunk in chunks:
